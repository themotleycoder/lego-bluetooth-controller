# Vendored, unmodified, from https://github.com/micropython/micropython-lib
# (micropython/umqtt.simple, MIT licensed). Not frozen into standard
# Raspberry Pi Pico/rp2 MicroPython firmware builds, unlike some ESP8266/
# ESP32 builds -- vendored here so setup does not depend on network access
# or `mip install` at deploy time. See the upstream repo for full docs.
