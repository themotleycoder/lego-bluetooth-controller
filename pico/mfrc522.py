# Vendored, unmodified, from https://github.com/danjperron/micropython-mfrc522
# (master branch, MIT licensed). MicroPython driver for the MFRC522 RFID
# reader; see the upstream repository for the original LICENSE and docs.
